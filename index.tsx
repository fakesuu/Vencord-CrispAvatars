...
export default definePlugin({
    name: "CrispAvatars",
    description: "Quadruples the resolution of profile pictures globally for maximum sharpness.",
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // Multiplier set to 4
                replace: "$& if($2 && $2.size) { $2.size = Math.min($2.size * 4, 4096); } "
            }
        },
        {
        ...
        },
        {
            ...
            replacement: {
                ...
                // Multipliers set to 4 for both scenarios
                replace: "$1$2$3 if(typeof $2 === 'number') { $2 = Math.min($2 * 4, 4096); } else if($2 && typeof $2.size === 'number') { $2.size = Math.min($2.size * 4, 4096); } "
            }
        }
    ]
});/*
